      ...
      <AuthProvider>
        <ComparisonProvider>
          <ToastProvider>
            ...
            <Router>
              <Routes>
                {/* Main layout route for home */}
                <Route path="/" element={<MainLayout />} />

                {/* Specific Public Auth Routes */}
                <Route path="/login/customer" element={<MainLayout />} />
                <Route path="/login/retailer" element={<MainLayout />} />
                <Route path="/login/wholesaler" element={<MainLayout />} />

                <Route path="/signup/customer" element={<MainLayout />} />
                <Route path="/signup/retailer" element={<MainLayout />} />
                <Route path="/signup/wholesaler" element={<MainLayout />} />

                {/* Secret Admin Route */}
                <Route path="/secret-admin-login" element={<MainLayout />} />
