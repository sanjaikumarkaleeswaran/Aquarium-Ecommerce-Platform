...
async function updateAntiParasiteImage() {
  try {
    // Connect to MongoDB
    ...
    const newImageUrl = 'https://m.media-amazon.com/images/I/71zV+WKAInL._AC_UF1000,1000_QL80_.jpg';
